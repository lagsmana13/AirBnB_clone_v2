...
class test_inherit_basemodel(unittest.TestCase):
    """Make Test if user inherit from BaseModel"""
...
class test_Amenity_BaseModel(unittest.TestCase):
    ...
    def test_user_id_and_createat(self):
        """Start testing id for every user"""
        user_1 = Amenity()
        sleep(2)
        user_2 = Amenity()
        sleep(2)
...
class TestAmenity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """Go Test that Amenity has attribute name, and it's as an empty string"""
        amenity = Amenity()
    ...
    def test_to_dict_creates_dict(self):
        """start test to_dict method creates a dictionary with proper attrs"""
        am = Amenity()
        print(am.__dict__)
        new_d = am.to_dict()
    ...
    def test_to_dict_values(self):
        """make test that values in dict returned from to_dict are correct"""
